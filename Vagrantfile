...
Vagrant.configure("2") do |config|
  config.vm.synced_folder "./shared/", "/shared", docker_consistency: "delegated", create: "true"
  config.vm.synced_folder "./dataset/", "/dataset", docker_consistency: "delegated", create: "true"
